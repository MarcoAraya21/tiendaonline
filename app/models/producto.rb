class Producto < ApplicationRecord
  ...
  belongs_to :producttype
	...
	validates :Precio,format:{with: /(^[0-9]{3,8})/,:message=>"de 3 a 8 caracteres,positivo"}
	validates :Stock,format:{with: /(^[1-9]{1,3})/,:message=>"de 1 a 3 caracteres,numero mayor a 0"}
