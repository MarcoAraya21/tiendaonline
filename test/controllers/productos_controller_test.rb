...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { Descripcion: @producto.Descripcion, Imagen: @producto.Imagen, Modelo: @producto.Modelo, Nombre: @producto.Nombre, Precio: @producto.Precio, Stock: @producto.Stock, category_id: @producto.category_id } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { Descripcion: @producto.Descripcion, Imagen: @producto.Imagen, Modelo: @producto.Modelo, Nombre: @producto.Nombre, Precio: @producto.Precio, Stock: @producto.Stock, category_id: @producto.category_id } }
